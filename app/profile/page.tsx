...
import { Building2, Save, CheckCircle2, ShieldCheck, Lock, Trash2, AlertTriangle, Globe, Loader2, Check } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      {/* Danger Zone Section */}
      <div className="mt-12 border border-red-200 bg-red-50/10 rounded-3xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2 max-w-3xl">
            <h2 className="text-xl font-bold text-red-900 flex items-center gap-2">
              <AlertTriangle className="h-6 w-6 text-red-650 animate-pulse" />
              Workforce Exit & Data Erasure Portal (GDPR Right-to-be-Forgotten)
            </h2>
            <p className="text-sm text-neutral-600 leading-relaxed">
              As the Slovenia operations project has been postponed, you have the full legal right to immediately request the permanent deletion and complete purging of your personal profile, national identification records (EMSO), banking details (IBAN/SWIFT), attendance logs, and past work metrics from our databases.
            </p>
            <p className="text-xs text-neutral-500 font-semibold italic">
              *Note: This operation is permanent, real-time, and will delete your credentials from all server caches and the network.
            </p>
          </div>
          <div className="shrink-0 flex items-center">
            <button
              ...
              className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-red-650 hover:bg-red-750 text-white font-bold rounded-xl transition-all shadow-md shadow-red-500/10 hover:shadow-lg active:scale-95 cursor-pointer text-sm"
            >
            ...
            {isPurgeComplete ? (
              <div className="bg-red-950/20 border border-red-900/50 rounded-xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
                ...
                <button
                  ...
                  className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-lg transition-colors cursor-pointer"
                >
                  Exit and Logout
                </button>
              </div>
